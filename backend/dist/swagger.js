...
exports.openApiSpec = {
    ...
    info: {
        ...
        version: "0.1.0",
        description: "API de génération de PDFs en batch (Producer/Consumer via BullMQ, stockage via MongoDB/GridFS, génération via Piscina)."
    },
    ...
    paths: {
        "/api/documents/batch": {
            post: {
                tags: ["Batch"],
                summary: "Créer un batch de 1000 IDs",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
                    ...
                    "400": {
                        ...
                        content: {
                            "application/json": {
                                ...
                                examples: {
                                    badCount: { value: { error: "IDs array must contain exactly 1000 items" } },
